...
def create_care_plan_request(form_data):
...
def get_care_plan_by_id(care_plan_id):
...
def get_care_plan_status_by_id(care_plan_id):
    return CarePlan.objects.only("id", "status", "content").get(id=care_plan_id)
